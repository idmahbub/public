...
<table class="table">
  <tr>
    <td>&nbsp;</td>
    <td ><strong>Soal Nomer&nbsp;<? echo $mhs01['XNomerSoal']; ?><input name="urut" type="hidden" value="<? echo $mhs01['Urut']; ?>" /><input name="kose" type="hidden" value="<? echo $mhs01['XKodeSoal']; ?>" /></strong></td>
  </tr>
  <tr>
