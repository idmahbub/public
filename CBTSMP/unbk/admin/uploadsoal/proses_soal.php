...
for ($i=2; $i<=$baris; $i++)
{
  ...
  $xjwban = $data->val($i, 7);
		  ...
		  $query = "INSERT INTO cbt_soal (XNomerSoal, XKodeMapel, XKodeSoal,XKodeKelas, XTanya, XJawab1, XJawab2, XJawab3, XJawab4, 
		   XKunciJawaban) VALUES ('$xnomer', '$xkodemapel', '$xkodesoal','$xkodekelas','$xtanya','$xjawab1',
		  '$xjawab2','$xjawab3','$xjawab4','$xjwban')";
